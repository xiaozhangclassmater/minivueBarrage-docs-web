...
export class BarrageManager {
  ...
  setDefautColor = (value) => { this.defaultColor !== value && (this.defaultColor = value) }
  
  computedTopValue = (rowIndex = 0) => `${(rowIndex * this.BarrageVueInstance.rowHeight) / 100}rem`
  /**
   * 
   * @param {} barrage
   * @description 添加弹幕 
